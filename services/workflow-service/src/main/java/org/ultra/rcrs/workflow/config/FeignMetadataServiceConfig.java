...
@Slf4j
@Configuration
public class FeignMetadataServiceConfig {

    @Bean("requestInterceptorMetadata")
    public RequestInterceptor requestInterceptorMetadata(OAuth2AuthorizedClientManager oAuth2AuthorizedClientManager) {
