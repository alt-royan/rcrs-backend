...
public class AlbumStandalone {
    ...
    public AlbumStandalone(Album album, String coverUrl, Set<ArtistSimple> mainArtists) {
    ...
    public AlbumStandalone(AlbumByArtist album, String coverUrl, Set<ArtistSimple> mainArtists) {
        this.id = Url62.encode(album.getAlbumId());
        this.status = album.getKey().getAlbumStatus();
        this.title = album.getTitle();
        this.totalDurationMs = album.getTotalDurationMs();
        this.type = album.getKey().getAlbumType();
        this.year = album.getYear();
        this.releaseDate = album.getKey().getReleaseDate().toLocalDate();
        this.coverUrl = coverUrl;
        this.totalTracks = album.getTotalTracks();
        this.explicit = album.getExplicit();
        this.available = album.getAvailable();
