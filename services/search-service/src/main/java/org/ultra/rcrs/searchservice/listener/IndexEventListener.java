...
import org.ultra.rcrs.searchservice.service.AlbumIndexService;
import org.ultra.rcrs.searchservice.service.ArtistIndexService;
import org.ultra.rcrs.searchservice.service.TrackIndexService;
...
public class IndexEventListener {
    ...
    private final AlbumIndexService albumIndexService;
    private final TrackIndexService trackIndexService;

    @KafkaListener(topics = Topics.SEARCH_INDEX_TOPIC, groupId = "search-group", containerFactory = "byteArrayContainerFactory")
    ...
    private void onArtistCreated(Any payload) {
        try {
            ...
            artistIndexService.handleArtistCreated(event);
        } catch (Exception e) {
    ...
    private void onArtistDeleted(Any payload) {
        try {
            ...
            artistIndexService.handleArtistDeleted(event.getId());
        } catch (Exception e) {
    ...
    private void onArtistHidden(Any payload) {
        try {
            ...
            artistIndexService.handleArtistHidden(event.getId());
        } catch (Exception e) {
    ...
    private void onAlbumCreated(Any payload) {
        try {
            ...
            albumIndexService.handleAlbumCreated(event);
        } catch (Exception e) {
    ...
    private void onAlbumDeleted(Any payload) {
        try {
            ...
            albumIndexService.handleAlbumDeleted(event.getId());
        } catch (Exception e) {
    ...
    private void onAlbumHidden(Any payload) {
        try {
            ...
            albumIndexService.handleAlbumHidden(event.getId());
        } catch (Exception e) {
    ...
    private void onTrackCreated(Any payload) {
        try {
            ...
            trackIndexService.handleTrackCreated(event);
        } catch (Exception e) {
    ...
    private void onTrackDeleted(Any payload) {
        try {
            ...
            trackIndexService.handleTrackDeleted(event.getId());
        } catch (Exception e) {
    ...
    private void onTrackHidden(Any payload) {
        try {
            ...
            trackIndexService.handleTrackHidden(event.getId());
        } catch (Exception e) {
    ...
    private void onArtistAddedToTrack(Any payload) {
        try {
            ...
            trackIndexService.handleArtistAddedToTrack(event);
        } catch (Exception e) {
    ...
    private void onArtistAddedToAlbum(Any payload) {
        try {
            ...
            albumIndexService.handleArtistAddedToAlbum(event);
        } catch (Exception e) {
    ...
    private void onOtherAddedToTrack(Any payload) {
        try {
            ...
            trackIndexService.handleOtherAddedToTrack(event);
        } catch (Exception e) {
    ...
    private void onOtherDeletedFromTrack(Any payload) {
        try {
            ...
            trackIndexService.handleOtherDeletedFromTrack(event);
        } catch (Exception e) {
    ...
    private void onArtistDeletedFromAlbum(Any payload) {
        try {
            ...
            albumIndexService.handleArtistDeletedFromAlbum(event);
        } catch (Exception e) {
    ...
    private void onArtistDeletedFromTrack(Any payload) {
        try {
            ...
            trackIndexService.handleArtistDeletedFromTrack(event);
        } catch (Exception e) {
    ...
    private void onAlbumLifecycleStatusUpdated(Any payload) {
        try {
            ...
            albumIndexService.handleAlbumLifecycleStatusUpdated(event);
        } catch (Exception e) {
    ...
    private void onTrackLifecycleStatusUpdated(Any payload) {
        try {
            ...
            trackIndexService.handleTrackLifecycleStatusUpdated(event);
        } catch (Exception e) {
    ...
    private void onTrackUpdated(Any payload) {
        try {
            ...
            trackIndexService.handleTrackUpdated(event);
        } catch (Exception e) {
    ...
    private void onTrackAddedToAlbum(Any payload) {
        try {
            ...
            trackIndexService.handleTrackAddedToAlbum(event);
        } catch (Exception e) {
    ...
    private void onArtistActivated(Any payload) {
        try {
            ...
            artistIndexService.handleArtistActivated(event.getId());
        } catch (Exception e) {
    ...
    private void onAlbumActivated(Any payload) {
        try {
            ...
            albumIndexService.handleAlbumActivated(event.getId());
        } catch (Exception e) {
