...
class AlbumAdminControllerIntegrationTest extends BaseIntegrationTest {
    ...
    void getAlbum_createdLifecycleStatus_200ReturnsData() {
        ...
        webTestClient.get()
                .uri("/api/catalog/admin/albums/{id}", album.getId())
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    void getAlbum_nonExistentId_404NotFound() {
        webTestClient.get()
                .uri("/api/catalog/admin/albums/{id}", "non-existent-id")
                .exchange()
    ...
    void getTracksByAlbum_returnsAllTracksRegardlessOfStatus() {
        ...
        webTestClient.get()
                .uri("/api/catalog/admin/albums/{id}/tracks", album.getId())
                .exchange()
                .expectStatus().isOk()
